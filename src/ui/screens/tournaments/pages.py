"""Demais telas do domínio Torneio, ainda no formato antigo (B-6).

Central do torneio, Equipes, árbitros do torneio e o construtor de ritmo.
Vieram inteiras do `screens/tournaments.py` original, **sem alteração de
comportamento**: a B-6 migrou a tela de *lista* para as três camadas e deixou
estas registradas como as próximas — migrar quatro telas no mesmo passo seria
trocar um diff revisável por um irrevisável.
"""
...
class TournamentOtherPagesMixin:
